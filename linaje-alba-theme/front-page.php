    ...
    <section class="hero">
        <div class="container hero-grid">
            ...
            <div class="hero-image personal-branded">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/girl.png" alt="Linaje Alba Lead Consultant" class="float-image">
            </div>
        </div>
    </section>
    ...
    <section id="highlights" class="container">
        ...
        <div class="highlights-grid">
            ...
            <div class="highlight-card highlight-dark">
                ...
                <div class="highlight-img-placeholder">Foto Cuidado Personal</div>
            </div>
        </div>
    </section>
    ...
    <section class="consultant-section">
        <div class="container">
            <div class="benefits-header">
                <h2>TU CAMINO DE<br>CONSULTOR EMPIEZA AQUÍ</h2>
    ...
    <section id="vip-benefits" class="vip-section container">
        ...
        <div class="vip-levels-grid">
            ...
            <div class="vip-card vip-card-morado">
                ...
                <div
                    style="margin-top: auto; padding-top: 1rem; width: 100%; border-top: 1px solid rgba(255,255,255,0.3); font-size: 0.8rem;">
                    Ver más
                </div>
            </div>
            ...
            <div class="vip-card vip-card-oro">
                ...
                <div
                    style="margin-top: auto; padding-top: 1rem; width: 100%; border-top: 1px solid rgba(74, 59, 24, 0.2); font-size: 0.8rem;">
                    Ver más
                </div>
            </div>
            ...
            <div class="vip-card vip-card-diamante">
                ...
                <div
                    style="margin-top: auto; padding-top: 1rem; width: 100%; border-top: 1px solid rgba(0,0,0,0.1); font-size: 0.8rem;">
                    Ver más
                </div>
            </div>
        </div>
    ...
    <section id="requirements" class="requirements-section-light">
        <div class="container">
            <div class="req-header">
                <h4>Requisitos para ser Consultora JAFRA</h4>
            ...
            <div class="requirements-grid">
                ...
                <div class="req-column">
                    <h3>Requisitos obligatorios para ser Consultora Jafra:</h3>
